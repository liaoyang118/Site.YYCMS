...
namespace Site.Common
{
    public static class Entity
    {
        ...
        /// <returns></returns>
        public static T CreateChannel<T>(SiteEnum.SiteService serviceName)
        {
        ...
        #region 扩展方法 + ToInt32(this String str, int defaultValue)
        /// <summary>
        /// 扩展方法
        /// </summary>
        /// <param name="str"></param>
        ...
        #region 转换日期格式 + string ToStringFullDate(this DateTime str)
        /// <summary>
        ...
        #region 返回指定长度的元素，如何集合元素长度小于指定数，则返回集合的长度 + static int GetLength<T>(this List<T> list, int length)
        /// <summary>
        ...
        #region 返回指定长度的元素,如何集合元素长度小于指定数，则返回整个集合 + List<T> GetLengthObject<T>(this List<T> list, int length)
        /// <summary>
        ...
        #region 截取指定长度的省略字段 + string SubOmitString(this string value, int length)
        /// <summary>
        /// 截取指定长度的省略字段
        /// </summary>
